...
#11 USING WINDOW AND ROW FUNCTION
SELECT NAME,QUANTITY_SOLD,AVG_QUANTITY FROM
(SELECT
PRODUCTS.PRODUCT_NAME AS NAME,
SALES.QUANTITY_SOLD,
AVG(SALES.QUANTITY_SOLD) OVER (PARTITION BY PRODUCTS.PRODUCT_NAME) AS AVG_QUANTITY,
ROW_NUMBER() OVER(PARTITION BY PRODUCTS.PRODUCT_NAME ORDER BY SALES.QUANTITY_SOLD DESC)
AS RN
    FROM PRODUCTS
    JOIN SALES 
